...
schelling_4 = Schelling(50, 50, 0.3, 0.8, 2500, 5)
schelling_4.populate()


schelling_1.plot('Schelling Model with 2 colors: Initial State with Similarity Threshold 30%', 'schelling_2_30_initial.png')
schelling_2.plot('Schelling Model with 2 colors: Initial State with Similarity Threshold 50%', 'schelling_2_50_initial.png')
schelling_3.plot('Schelling Model with 2 colors: Initial State with Similarity Threshold 80%', 'schelling_2_80_initial.png')
schelling_3.plot('Schelling Model with 5 colors: Initial State with Similarity Threshold 80%', 'schelling_5_80_initial.png')
...
schelling_4.plot('Schelling Model with 5 colors: Final State with Similarity Threshold 80%', 'schelling_5_80_final.png')
